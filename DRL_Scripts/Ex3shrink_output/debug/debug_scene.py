...
paramWrapper = ('/pneu', {'paramForcefield': {'periodSaveGIE': 6, 'prepareECSW': True, 'modesPath': '/home/owen/Softwares/Ext_plugin_repo2/ModelOrderReduction/tools/sofa_test_scene/Ex3shrink_output/data/modes.txt', 'nbTrainingSet': 12}, 'paramMORMapping': {'input': '@../MechanicalObject', 'modesPath': '/home/owen/Softwares/Ext_plugin_repo2/ModelOrderReduction/tools/sofa_test_scene/Ex3shrink_output/data/modes.txt'}, 'paramMappedMatrixMapping': {'object1': '@./MechanicalObject', 'object2': '@./MechanicalObject', 'template': 'Vec1d,Vec1d', 'timeInvariantMapping2': True, 'performECSW': False, 'timeInvariantMapping1': True, 'nodeToParse': '@./pneu'}})
